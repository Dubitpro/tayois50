...
export default function Biography() {
  ...
  const timeline = [
    { year: "1976–1989", title: "Early Life", desc: "Dr. Omotayo Oluseyi Osinaike was born on August 9, 1976, in Lagos, Nigeria, to Bamidele Dania of Iku Akoko and Christiana Dania of Ode Omu. Her childhood unfolded between Lagos and Ode Omu, giving her a rich blend of urban exposure and deep cultural grounding. She completed her primary education at Command Children School, Lagos, in 1989.", details: "During these formative years, she was shaped by the moral and spiritual guidance of Reverend and Mrs. Agbelusi and the nurturing environment of Dansol Tutorial Centre under the leadership of Mrs Akinyemiju—communities that helped establish her early godly character and disciplined outlook. Growing up within a well connected extended family, she enjoyed many short and long stays with relatives, experiences that broadened her worldview and strengthened her interpersonal warmth." },
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
            ...
            <motion.div 
              ...
              className="space-y-6"
            >
              <h2 className="font-cormorant text-4xl text-elegant-black">A Visionary Woman</h2>
              <p className="font-sans text-elegant-black/80 leading-relaxed text-lg text-justify">
                Dr. Omotayo Oluseyi Osinaike, born in Lagos in 1976, shaped by strong family values, spiritual guidance, and disciplined academic foundations. Her faith deepened during her time at Federal Government Girls College, Akure, becoming the anchor for her identity. She pursued medicine at the University of Ibadan/UCH, a journey that strengthened her resilience. During this period, she married Ademola Osinaike and began building her family, welcoming three children between 2006 and 2015.
              </p>
              <p className="font-sans text-elegant-black/80 leading-relaxed text-lg mt-4 text-justify">
